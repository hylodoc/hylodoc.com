...
This document, the "Policy," outlines the Knuthic project's (the "Project")
...
1. Our word trademarks and service marks (the "Word Marks"):
    ...
    |-----------|-------------------------------------------------------|
    | KNUTHIC	| software platform					|
    | KNU	| software tool						|

2. Our logos (the "Logos"):

    ![Knuthic logo](logo.svg)
...
distributing the Knuthic software when you're distributing a modified version of
...
though, say you like the Knuthic software, that you participate in the Knuthic
community, that you are providing an unmodified version of the Knuthic software,
or that you wrote a book describing how to use the Knuthic software.
...
ours. So you may say, for example, "Bob's software for the Knuthic platform"
but may not say "Bob's Knuthic software." Some other examples that may work
for you are:

- [Your software] works with Knuthic software

- [Your software] uses Knuthic software

- [Your software] is compatible with Knuthic software

- [Your software] is powered by Knuthic software

- [Your software] runs on Knuthic software

- [Your software] for use with Knuthic software

- [Your software] for Knuthic software.
...
"Knuthic is trademark of the Knuthic Project. Used with permission from the
Knuthic Project."
...
our Marks, please email us at [tm@knuthic.com](mailto:tm@knuthic.com).
...
- Unacceptable: knuthic

- Acceptable: Knuthic, KNUTHIC
...
- Unacceptable: I have seventeen Knuthics running in my lab.

- Acceptable: I have seventeen Knuthic systems running in my lab.

##### Don't use "a" or "the" to refer to an instance of the trademark.

- Unacceptable: I put a Knuthic on my mom's computer.

- Acceptable: I put a Knuthic system on my mom's computer.

##### Always use a trademark as an adjective modifying a noun. You can see the nouns we prefer under "Our trademarks."

- Unacceptable: This is a Knuthic. Anyone can install it.

- Acceptable: This is a Knuthic application. Anyone can install it.

##### Don't use a trademark as a verb. Trademarks are products or services, never actions.

- Unacceptable: I Knuthicified my computer today!

- Acceptable: I installed Knuthic software on my computer today!
...
- Unacceptable: Knuthic's desktop interface is very clean.

- Acceptable: The Knuthic desktop's interface is very clean.

##### Don't translate a trademark into another language.

- Unacceptable: Quiero instalar el Knuthico en mi sistema.

- Acceptable: Quiero instalar Knuthic en mi sistema.
